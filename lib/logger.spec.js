...
const testBatchData = [ { "key" : 4321 },
                        { "key" : 4322 }];
const batchSize = 1;
const postInterval = 1;
...
describe('The logger module', function () {
  ...
  it( 'sends batch log messages to the server', function(done) {
    ...
    logger.logBatch( testBatchData, batchSize, postInterval, (err,success)=>{
      server.close();
